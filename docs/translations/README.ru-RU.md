...
<p align="center">
  <em>DECOUPLE.html на реальном запуске (AutoCheck/Touchstone Explorer) — клик по предложенному классу показывает, с каким именно другим классом он делит состояние и что конкретно является общим.</em>
</p>
